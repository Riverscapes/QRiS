...
ALTER TABLE brat_cis ADD COLUMN base_streampower_id INT NOT NULL REFERENCES lkp_brat_base_streampower(id);
ALTER TABLE brat_cis ADD COLUMN high_streampower_id INT NOT NULL REFERENCES lkp_brat_high_streampower(id);
ALTER TABLE brat_cis ADD COLUMN streamside_veg_id INT NOT NULL REFERENCES lkp_brat_vegetation_types(id);
ALTER TABLE brat_cis ADD COLUMN riparian_veg_id INT NOT NULL REFERENCES lkp_brat_vegetation_types(id);
ALTER TABLE brat_cis ADD COLUMN veg_density_id INT NOT NULL REFERENCES lkp_brat_dam_density(id);
ALTER TABLE brat_cis ADD COLUMN combined_density_id INT NOT NULL REFERENCES lkp_brat_dam_density(id);
