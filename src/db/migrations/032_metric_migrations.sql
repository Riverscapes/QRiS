...
UPDATE metrics SET
    metadata = '"minimum_value": 0.0, "maximum_value": null, "precision": 3}',
...
UPDATE metrics SET
    metadata = '{"minimum_value": 0.0, "maximum_value": null, "precision": 1}',
...
UPDATE metrics SET
    metadata = '{"minimum_value": 0.0, "maximum_value": null, "precision": 2}',
    metric_params = '{"dce_layers": [{"layer_id_ref": "centerlines"}]}'
...
WHERE machine_name = 'precent_free_flowing';
