...
UPDATE layers SET metadata = '{"hierarchy": ["Assessments", "Beaver Dam Building"], "fields": [{"id": "structure_source_id", "type": "list", "label": "Structure Source", "required": false, "custom_values_allowed": false, "values": ["Artificial", "Natural", "Unknown"]}, {"id": "dam_state", "type": "list", "label": "Dam State", "required": false, "custom_values_allowed": false, "values": ["Blown Out", "Breached", "Intact"]}, {"id": "crest_type", "type": "list", "label": "Crest Type", "required": false, "custom_values_allowed": false, "values": ["Active", "Inactive"]}, {"id": "confidence", "type": "list", "label": "Confidence", "required": false, "custom_values_allowed": false, "values": ["High", "Medium", "Low"]}]}' WHERE fc_name = 'dam_crests';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Geomorphic Mapping", "Channel"], "fields": []}' WHERE fc_name = 'active_channel';
UPDATE layers SET metadata = '{"menu_items": ["copy_from_valley_bottom"], "hierarchy": ["Observations", "Geomorphic Mapping", "Floodplain"], "fields": [{"id": "type_id", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Active", "Inactive"]}]}' WHERE fc_name = 'active_extents';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Geomorphic Mapping", "Channel"], "fields": [{"id": "type_id", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Primary", "Non-Primary"]}, {"id": "description", "type": "list", "label": "Description", "required": false, "custom_values_allowed": false, "values": ["Centerline", "Thalweg"], "default_value": "Centerline"}]}' WHERE fc_name = 'centerlines';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Hydraulic Mapping"], "fields": [{"id": "type_id", "type": "list", "label": "Extent Type", "required": false, "custom_values_allowed": false, "values": ["Free Flowing", "Overflow", "Ponded"]}]}' WHERE fc_name = 'inundation_extents';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Geomorphic Mapping", "Channel"], "fields": [{"id": "junction_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Channel Head", "Confluence (Anabranch)", "Confluence (Tributary)", "Diffluence"]}]}' WHERE fc_name = 'channel_junctions';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Geomorphic Mapping", "Channel"], "fields": [{"id": "geomorphic_unit_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Bank Attached Bar", "Chute", "Glide/Run", "Mid Channel Bar", "Pond", "Pool", "Rapid", "Riffle"]}, {"id": "geomorphic_unit_type_2_tier", "type": "list", "label": "Type 2 Tier", "required": false, "custom_values_allowed": false, "values": ["Bowl", "Mound", "Plane", "Saddle", "Trough"]}]}' WHERE fc_name = 'geomorphic_unit_extents';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Geomorphic Mapping", "Channel"], "fields": [{"id": "geomorphic_unit_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Bank Attached Bar", "Chute", "Glide/Run", "Mid Channel Bar", "Pond", "Pool", "Rapid", "Riffle"]}, {"id": "geomorphic_unit_type_2_tier", "type": "list", "label": "Type 2 Tier", "required": false, "custom_values_allowed": false, "values": ["Bowl", "Mound", "Plane", "Saddle", "Trough"]}, {"id": "length", "type": "float", "label": "Length", "required": false, "custom_values_allowed": false}, {"id": "width", "type": "float", "label": "Width", "required": false, "custom_values_allowed": false}, {"id": "depth", "type": "float", "label": "Depth", "required": false, "custom_values_allowed": false}]}' WHERE fc_name = 'geomorphic_units';
UPDATE layers SET metadata = '{"menu_items": ["copy_from_valley_bottom"], "hierarchy": ["Assessments", "Geomorphic Condition"], "fields": [{"id": "sem_stage", "type": "list", "label": "SEM Stage", "required": false, "custom_values_allowed": false, "values": ["0 Anastomosing", "1 Sinuous Single Thread", "2 Channelized", "3 Degradation", "4 Degradation and Widening", "5 Aggradation and Widening", "6 Quasi Equilibrium", "7 Laterally Active", "8 Anastomosing"]}]}' WHERE fc_name = 'cem_phases';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Vegetation Mapping"], "fields": [{"id": "vegetation_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Riparian", "Non-Riparian"]}, {"id": "vegetation_tier_2_type", "type": "list", "label": "Type 2 Tier", "required": false, "custom_values_allowed": false, "values": ["Emergent Riparian", "Woody Riparian"]}, {"id": "suitability", "type": "list", "label": "Brat Suitability", "required": false, "custom_values_allowed": false, "values": ["Preferred", "Suitable", "Moderately Suitable", "Barely Suitable", "Unsuitable"]}]}' WHERE fc_name = 'vegetation_extents';
UPDATE layers SET metadata = '{"menu_items": ["import_photos"], "hierarchy": ["Observations", "Other"], "fields": [{"id": "photo_path", "type": "attachment", "label": "Photo Path", "required": false, "custom_values_allowed": false}]}' WHERE fc_name = 'observation_points_dce';
...
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Structural Elements"], "fields": [{"id": "structural_element_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Dam", "Dam Complex", "Jam", "Jam Complex", "Other", "Root Mass"]}, {"id": "structure_count", "type": "integer", "label": "Structure Count", "required": false, "custom_values_allowed": false, "default_value": "1", "visibility_values": []}, {"id": "length", "type": "float", "label": "Length", "required": false, "custom_values_allowed": false, "visibility_values": []}, {"id": "width", "type": "float", "label": "Width", "required": false, "custom_values_allowed": false, "visibility_values": []}, {"id": "height", "type": "float", "label": "Height", "required": false, "custom_values_allowed": false, "visibility_values": []}, {"id": "large_wood_count", "type": "integer", "label": "Large Wood Count", "required": false, "custom_values_allowed": false}]}' WHERE fc_name = 'structural_elements_points';
UPDATE layers SET metadata = '{"hierarchy": ["Observations", "Structural Elements"], "fields": [{"id": "structural_element_type", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Dam"]}]}' WHERE fc_name = 'structural_elements_lines';
...
UPDATE layers SET metadata = '{"hierarchy": ["Assessments", "Risk Potential"], "fields": [{"id": "risk_type", "type": "list", "label": "Risk", "required": false, "custom_values_allowed": false, "values": ["High", "Medium", "Low"]}, {"id": "risk_type_source", "type": "list", "label": "Type", "required": false, "custom_values_allowed": false, "values": ["Bridge", "Culvert", "Diversion"]}]}' WHERE fc_name = 'risk_potential_points';
