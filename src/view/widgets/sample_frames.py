...
class SampleFrameWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget, qris_project: Project, qris_map_manager: QRisMapManager = None, first_index_empty: bool = False, sample_frame_types: Optional[list] = None):
        if sample_frame_types is None:
            sample_frame_types = [SampleFrame.SAMPLE_FRAME_TYPE]
    ...
    def on_sample_frame_changed(self):
        ...
        if self.qris_map_manager is not None:
            ...
            if sample_frame.sample_frame_type == SampleFrame.VALLEY_BOTTOM_SAMPLE_FRAME_TYPE:
                ...
                self.qris_map_manager.build_aoi_layer(sample_frame)
            else:
                self.qris_map_manager.build_sample_frame_layer(sample_frame)
