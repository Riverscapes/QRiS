...
class DependantComboBox(QWidget):
    def __init__(self, parent: MetadataFieldEditWidget = None, values: typing.Optional[list] = None, dependency_map: typing.Optional[dict[str, list[str]]] = None, default_value=None):
    ...
    def setValueExternal(self, value, widget_values: dict[str, str]):
    ...
    def set_dependent_value(self, widget_values: dict[str, str]):
