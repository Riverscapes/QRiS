...
class FrmExportLayer(QtWidgets.QDialog):
    def __init__(self, parent, layer: QgsVectorLayer, base_name: Optional[str] = None, project_path: Optional[str] = None):
    ...
    def browse_file(self):
        ...
        filename, _selected_filter = QtWidgets.QFileDialog.getSaveFileName(self, "Select Output File", initial_dir, filter_str)
        if filename:
