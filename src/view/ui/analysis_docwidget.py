...
class Ui_AnalysisDocWidget(object):
    def setupUi(self, AnalysisDocWidget):
        ...
        self.cboEvent = QtWidgets.QComboBox(self.dockWidgetContents)
        self.cboEvent.setObjectName("cboEvent")
        self.gridLayout.addWidget(self.cboEvent, 2, 2, 1, 1)
        self.lblEvent = QtWidgets.QLabel(self.dockWidgetContents)
        self.lblEvent.setObjectName("lblEvent")
        self.gridLayout.addWidget(self.lblEvent, 2, 1, 1, 1)
    ...
    def retranslateUi(self, AnalysisDocWidget):
        ...
        self.lblEvent.setText(_translate("AnalysisDocWidget", "Data Capture Event"))
