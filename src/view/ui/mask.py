...
class Ui_Mask(object):
    def setupUi(self, Mask):
        ...
        self.mMapLayerComboBox = gui.QgsMapLayerComboBox(Mask)
        self.mMapLayerComboBox.setObjectName("mMapLayerComboBox")
        self.gridLayout.addWidget(self.mMapLayerComboBox, 2, 1, 1, 1)
        self.chkAddToMap = QtWidgets.QCheckBox(Mask)
        self.chkAddToMap.setObjectName("chkAddToMap")
        self.gridLayout.addWidget(self.chkAddToMap, 6, 1, 1, 1)
