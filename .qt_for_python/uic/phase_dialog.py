...
class Ui_design_dialog(object):
    def setupUi(self, design_dialog):
        ...
        self.comboBox_dominate_action = QtWidgets.QComboBox(design_dialog)
        self.comboBox_dominate_action.setObjectName("comboBox_dominate_action")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBox_dominate_action)
