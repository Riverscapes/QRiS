...
# Form implementation generated from reading ui file '/Users/nick/Library/Application Support/QGIS/QGIS3/profiles/test/python/plugins/RIPTPlugin/src/ui/add_layer_dialog.ui'
#
...
class Ui_dlgAddLayer(object):
    def setupUi(self, dlgAddLayer):
        ...
        self.comboBox_layer_type = QtWidgets.QComboBox(dlgAddLayer)
        self.comboBox_layer_type.setObjectName("comboBox_layer_type")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.comboBox_layer_type)
    ...
    def retranslateUi(self, dlgAddLayer):
        ...
        self.label_4.setText(_translate("dlgAddLayer", "Layer Type:"))
