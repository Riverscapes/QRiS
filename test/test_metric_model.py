...
class TestMetricAvailability(unittest.TestCase):
    def test_availability_case_insensitive_usage_grouping(self):
        ...
        metric_params = {"dce_layers": [{"layer_id_ref": "LAYER_A", "usage": "Input"}, {"layer_id_ref": "LAYER_B", "usage": "input"}]}
    ...
    def test_availability_strict_different_groups(self):
        ...
        """
        metric_params = {"dce_layers": [{"layer_id_ref": "LAYER_A", "usage": "numerator"}, {"layer_id_ref": "LAYER_B", "usage": "denominator"}]}
        ...
        # 2. Both -> Pass
        dce_both = MockEvent(102, [MockEventLayer(MockDBLayer(10, "LAYER_A")), MockEventLayer(MockDBLayer(11, "LAYER_B"))])
