...
from ..src.lib import climate_engine
...
class TestClimateEngine(unittest.TestCase):
    ...
    def test_get_dataset_timeseries_polygon_qgsgeometry(self, mock_post, mock_get_api_key):
        ...
        result = climate_engine.get_dataset_timeseries_polygon(dataset="test_ds", variables=["var1"], start_date="2020-01-01", end_date="2020-01-31", geometry=geometry)
    ...
    def test_get_dataset_zonal_stats_polygon(self, mock_post, mock_get_api_key):
        ...
        result = climate_engine.get_dataset_zonal_stats_polygon(dataset="test_ds", variables=["var1"], start_date="2020-01-01", end_date="2020-01-31", geometry=geometry)
