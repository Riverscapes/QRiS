...
from ..src.model.event_layer import EventLayer
...
class TestMetricFeasibility(unittest.TestCase):
    def setUp(self):
        ...
        self.project.layers = {"dem_layer": self.layer_dem, "centerline_layer": self.layer_centerline}
    ...
    def test_missing_metric_dependency(self):
        ...
        derived_params = {"metric_dependencies": [{"metric_id_ref": "base_metric", "protocol_machine_code_ref": "PROTO", "version": "1.0", "usage": "numerator"}]}
        derived_metric = Metric(2, "Derived", "derived_metric", "PROTO", "Desc", 1, "proportion", derived_params, version="1.0")
        self.analysis.analysis_metrics = {2: AnalysisMetric(derived_metric, 1)}
    ...
    def test_present_metric_dependency(self):
        ...
        self.analysis.analysis_metrics = {1: AnalysisMetric(base_metric, 1), 2: AnalysisMetric(derived_metric, 1)}
    ...
    def test_dependency_selected_but_not_feasible(self):
        ...
        base_metric = Metric(1, "Base Requires Input", "base_requires_input", "PROTO", "Desc", 1, "length", {"inputs": [{"input_ref": "dem_input"}]}, version="1.0")
        derived_params = {"metric_dependencies": [{"metric_id_ref": "base_requires_input", "protocol_machine_code_ref": "PROTO", "version": "1.0", "usage": "numerator"}]}
        derived_metric = Metric(2, "Derived", "derived_metric", "PROTO", "Desc", 1, "proportion", derived_params, version="1.0")
    ...
    def test_missing_layer_config_in_project(self):
        ...
        self.assertTrue(any("Not Found in Project" in r for r in result["reasons"]), f"Expected missing error, got {result['reasons']}")
    ...
    def test_missing_layer_in_dce(self):
        ...
        self.assertTrue(any("Not added to DCE" in r for r in result["reasons"]), f"Expected missing error, got {result['reasons']}")
    ...
    def test_usage_groups_or_logic(self, mock_connect):
        ...
        params = {"dce_layers": [{"layer_id_ref": "dem_layer", "usage": "elevation"}, {"layer_id_ref": "centerline_layer", "usage": "elevation"}]}
        metric = self.create_metric(params)
    ...
    def test_usage_groups_empty_data(self, mock_connect):
        ...
        params = {"dce_layers": [{"layer_id_ref": "dem_layer", "usage": "elevation"}]}
        metric = self.create_metric(params)
