...
class TestMetricConstraints(unittest.TestCase):
    def test_constraints_propagation(self):
        ...
        metric_metadata = {"minimum_value": 10.0, "maximum_value": 200.0, "precision": 2}
        ...
        # 2. Metric Value
        metric_value = MetricValue(metric=metric, manual_value=None, automated_value=None, is_manual=True, uncertainty=None, description="", unit_id=None, metadata={})
