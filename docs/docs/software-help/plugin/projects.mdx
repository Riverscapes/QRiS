...
In the video below, we run through the creation of a project, and what is happening on disk, and the components that make a QRiS project.
<YouTubeEmbed videoId="EykEOP5qN5Y" />



## Project Level Commands
Project level commands are accessed by a right click to the Project Folder (top folder) in the project tree of the QRiS Plugin Panel.

![commands](/images/software-help/ProjectCommands.png)
...
:::tip 
As your projects grow, this command becomes less and less useful as it just clutters your map and layer mangager. Remember, you can always add individual layers or layer groups to any map. Don't think of your map (or QGZ) as a container for your data. QRiS takes care of that for you. Just think of your map as an ephemeral page you can bring in layers you want to look at in that session.
:::
...
### Export as New Riverscapes Project


All QRIS projects exist simultaneously as a QRIS projact and a Riverscapes Studio project. This means upon creation of a new QRIS project a project.rs.xml is also ceated withing your project folder. This makes it possible to open the project in Riverscapes Viewer, as well as upload the project to the data exchange.

However, there is also the ability to export your project directly from the QRIS plugin as either a copy or as a custom export where you have chosen what elements of the project you want included.
