...
The Batch Attribute Editor allows you to edit the attributes of multiple features in a DCE layer at once. This tool is necessary since QRiS utilizes a custom data model and standard QGIS editing tools are not able to make edits to multiple features as they normally would. 

## Opening the Batch Attribute Editor

:::tip
It is best practice to make your feature selection prior to opening the Batch Attribute Editor since the batch editor will only edit the attributes of the selected features. 

The Batch Attribute Editor does contain an attribute table, however it has limited selection capabilities.
::: 
...
![Batch Attribute Editor](/images/software-help/open-batch-edit.gif) 
...
![Batch Attribute Editor chnages](/images/software-help/batch-edit-changes.gif) 