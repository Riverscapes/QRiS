...
## Adding a New Valley Bottom
### Import Existing Features as a New Valley Bottom
...
A common workflow is to import a VBET valley bottom into QRiS. You can do this easily by following the workflow for importing from a Riverscapes Project covered in [Riverscapes Viewer Integration](/software-help/riverscapes-viewer-integration/). Specifically you would download a VBET project and Import the Valley Bottom layer. 

### Create a New Valley Bottom from Scratch

You can create a new valley bottom by manually drawing a polygon on the map. To do this:
1. Click the **Create New (Manually Digitized) Valley Bottom** menu item on the **Riverscapes** node within your QRiS [project](/software-help/projects). 
2. Provide a name and optional description and metadata items for the new Valley Bottom. You can also specify if the Valley Bottom should be used as the Project Bounds for the project.
3. To start digitizing the Valley Bottom right away, make sure the **Add to Map** and **Start Edit Session** checkboxes are checked.
4. Add the Valley Bottom layer to the map by clicking the **Add to Map** button. You can now use the standard QGIS editing tools to digitize the valley bottom on the map. Remember to stop editing and save your changes to the valley bottom feature.
...
Finally, you can set the valley bottom as the project bounds by clicking the **Set as Project Bounds** box. This will display the valley bottom polygon as the project bounds in the Data Exchange map viewer when the QRiS project is uploaded for sharing.   
