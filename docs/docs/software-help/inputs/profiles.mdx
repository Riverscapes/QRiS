...
QRiS profiles represent longitudinal lines down your riverscape. The most common use is to represent the valley centerline. Profiles are used to create [cross sections](/software-help/cross-sections), and from there, generate [sample frames](/software-help/sample-frames). A valley centerline is also necessary for calcualting certain [Metrics](/software-help/metrics/) in [Analyses](/software-help/analyses/)
