...
Climate Engine Map Layers are for display purposes only and are not used in the QRiS analysis. They can be used to visualize climate data alongside your project data, providing a richer context for your analysis.

## Add Climate Engine Map Layer to Map
...
3. Select the desired Variable from the list. 
  ...
  :::tip Variable Information
  You can use the blue help button next to the variable list will navigate to the appropriate Climate Engine Datasets website for more information about the variables. 
  :::

The form will update to show the available time ranges for the selected variable.
