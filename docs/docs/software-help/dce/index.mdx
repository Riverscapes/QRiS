...
![dce-properties](/images/software-help/dce/DCE-Basic_Properties.png)
 ...
 The valley bottom polygon ssociated with your DCE can be selected under the `Associated Valley Bottom` section. This defines the boundary of your DCE and is linked to your DCE layers so it will be rendered alongside them in the map panel.   
...
Descriptive narrative related to the context, considerations, and constraints associated with the DCE. Descriptions may include (but not limited to) imagery context, etc.
