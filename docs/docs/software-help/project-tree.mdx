...
- **Browse Data Exchange Projects**: This will open a web browser to the [Riverscapes Data Exchange](data.riverscapes.net) at the same extents as your QGIS screen.
