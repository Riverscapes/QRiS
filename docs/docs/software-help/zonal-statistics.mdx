...
1. Click the `Export Data` button. The Export Geospatial Metrics form will open.

![Export Geospatial Metrics](/images/software-help/export-zonal-statistics.png)

2. Select the metrics you would like to export by checking the boxes next to the metrics in the tree. You may also click the `Select All` button to select all metrics or the `Select None` button to deselect all metrics.
3. Choose the file format you would like to export the data to (JSON, CSV or XLSX).
4. Specify the file name and location where you would like to save the exported file.
