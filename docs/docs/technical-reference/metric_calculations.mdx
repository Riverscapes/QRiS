...
:::warning
The proportion calcualtion can be used to normalize calculations with two different layer types such as integrated valley bottom width (riverscape area / rivercape length). However, the calculation will be displayed as unitless in the Analysis window. 
:::
