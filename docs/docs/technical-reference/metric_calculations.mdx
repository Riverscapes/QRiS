...
## Proportion
The proportion calculation calculates the generic proportion of the area or length of a polygon or linestring feature that falls within the sample frame or other specified layers.

calculation_name: `proportion`

![Proportion Calculation](/images/technical-reference/metrics/metric-area_proportion.png)

*Proportion calculation example. Sample Frames are shown in orange dashed outline and labeled 1 and 2. Geomorphic Unit Polygons for "Free Flowing" (magenta) and "Ponded" (blue) are shown. Several types of proportion metrics could be calculated from these layers, such as the proportion of the area of "Free Flowing" Geomorphic Units within the total area of the Sample Frame or the proportion of area of "Free Flowing" to total area of the Geomorphic Units (i.e. "Free Flowing" / ("Free Flowing" + "Ponded")).*
...
:::warning
The proportion calcualtion can be used to normalize calculations with two different layer types such as integrated valley bottom width (riverscape area / rivercape length). However, the calculation will be displayed as unitless in the Analysis window. Therefore, it is recommended to detail the calculation and its units under the description textbox of the metric. 
:::
