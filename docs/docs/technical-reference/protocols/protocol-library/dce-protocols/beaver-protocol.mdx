...
The **Beaver Protocol** is an assessment of beaver activity, dam & complex surveys, beaver translocations, and potential conflicts. This protocol is intended to assist with LTPBR planning & monitoring to evaluate and assess potential restoration sites for beaver presence, to collect field data and compare with modelled (e.g., BRAT) outputs, or to monitor as-builts for active beaver activity & use of LTPBR structures. 
...
**Field Label**|**Values**
---|---
*Type*|<li>Bank Den </li> <li>Bank Lodge</li><li>Canal</li><li>Chew Stick</li><li>Clipped Vegetation</li><li>Felled Tree</li><li>Food Cache</li><li>Harvested Branches</li><li>Other</li><li>Pond Excavation</li><li>Pond Lodge</li><li>Scat</li><li>Scent Mound</li><li>Set of Tracks</li><li>Skid Trail</li><li>Slide</li>
    </TabItem>
    <TabItem value="dam survey" label="Dam Survey">
**Type**|**Description**
---|---
...
<Tabs>
  <TabItem value="count" label="Count Metrics" default>

| Metric ID | Label | Precision | Description | Calculation |
| :--- | :--- | :--- | :--- | :--- |
| `dam_count` | **Total Dam Count** | 1 | Count of All Beaver Dams in Sample Frame. | `Count(Beaver Dams)` |
| `active_dam_count` | **Active Dam Count** | 1 | Count of All Active Beaver Dams (Maintained = Yes). | `Count(Maintained Beaver Dams)` |
| `inactive_dam_count` | **Inactive Dam Count** | 1 | Count of All Inactive Beaver Dams (Maintained = No). | `Count(Non-Maintained Beaver Dams)` |

  </TabItem>
  <TabItem value="density" label="Density Metrics">

| Metric ID | Label | Precision | Description | Calculation |
| :--- | :--- | :--- | :--- | :--- |
| `dam_density` | **Total Dam Density** | 3 | Density of All Beaver Dams normalized by Valley Bottom Centerline. | `Count(Beaver Dams)` / `Length (Valley Bottom Centerline)` |
| `active_dam_density` | **Active Dam Density** | 3 | Density of All Active Beaver Dams normalized by Valley Bottom Centerline. | `Count(Maintained Beaver Dams)` / `Length (Valley Bottom Centerline)` |
| `inactive_dam_density` | **Inactive Dam Density** | 3 | Density of All Inactive Beaver Dams normalized by Valley Bottom Centerline. | `Count(Non-Maintained Beaver Dams)` / `Length (Valley Bottom Centerline)` |
