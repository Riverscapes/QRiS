...
- **Stream Assessment**, their spatial distribution, and anticipated geomorphic & hydraulic changes to the riverscape. 
- **Risk Assessment** to identify overarching objectives for groups of structures.
- **Property Assessment** that may influence design decisions or project logistics.
- **Recovery Space** to support permit applications and inform landowners of potential project outcomes.
