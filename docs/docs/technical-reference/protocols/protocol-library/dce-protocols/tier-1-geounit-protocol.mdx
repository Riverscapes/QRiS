...
---|---|---|---
*Tier 1 Gemorphic Units*|Polygon|`Active Channel Proportion`, `Active Channel Area`, `Active Floodplain Proportion`, `Active Floodplain Area`, `Inactive Floodplain Proportion`, `Inactive Floodplain Area`|landforms shaped and distinguished by vertical flood stage height 
*Margins*|Linestring|`Total Margin Length`, `Margin Length (left)`, `Margin Length (right)`, `Proportion of Margin that is a Sediment Source`, `Proportion of Margin that is a Wood Source`|abutment of channel against valley bottom, valley, or anthropogenic feature. 
...
Once those layers are digitized, you can calculate metrics to assess the valley bottom’s condition and its restoration potential.
</details>
...
---|---
*Active Channel*|Portion of valley bottom that is inundated by bankfull flow.
...
Potential Sediment Source|Description
---|---
*Yes*|Margin can be a potential source of sediment to the active channel. LTPBR can target these areas through lateral erosion to provide sediment for the channel to rework downstream and enhance geomorphic diversity. For example, an alluvial fan or tributary fan are potential sediment sources. 
*No*|Margin is unlikely to be a source of sediment for the active channel. 

Potential Wood Source|Description
---|---
*Yes*|Margin can be a potential source of wood to the active channel. LTPBR can target these areas through lateral erosion to provide wood for the channel to rework at the source site or downstream and address structural starvation. For example, an alluvial fan or tributary fan are potential sediment sources. 
*No*|Margin is unlikely to be a source of wood for the active channel. 
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="Geomorphic Metrics" label="Geomorphic Metrics" default>
| Metric ID | Label | Precision | Description | Calculation |
| :--- | :--- | :--- | :--- | :--- |
| `active_channel_proportion` | Active Channel Proportion | 2 | Proportion of Active Channel(s) within Valley Bottom of Each Sample Frame| `Sum (Active Channel Area) / Valley Bottom Area` |
| `active_channel_area` | Active Channel Area | 2 | Area of Active Channel within Valley Bottom of Each Sample Frame | `Sum (Active Channel Area)` |
| `active_floodplain_proportion` | Active Floodplain Proportion | 2 | Proportion of Active Floodplain within Valley Bottom of Each Sample Frame | `Sum (Active Floodplain Area) / Valley Bottom Area` |
| `active_floodplain_area` | Active Floodplain Area | 2 | Area of Active Floodplain within Valley Bottom of Each Sample Frame | `Sum (Active Floodplain Area)` |
| `inactive_floodplain_proportion` | Inactive Floodplain Proportion | 2 | Proportion of Inactive Floodplain within Valley Bottom of Each Sample Frame | `Sum (Inactive Floodplain Area) / Valley Bottom Area` |
| `inactive_floodplain_area` | Inactive Floodplain Area | 2 | Area of Inactive Floodplain within Valley Bottom of Each Sample Frame | `Sum (Inactive Floodplain Area)` |
  </TabItem>
  <TabItem value="Margin Metrics" label="Margin Metrics">
| Metric ID | Label | Precision | Description | Calculation |
| :--- | :--- | :--- | :--- | :--- |
| `margin_length` | Total Margin Length | 2 | The total length of all margin types | `Sum (Total Margin Length)` |
| `margin_length_left` | Margin Length (left) | 2 | The total length of left valley bottom margins | `Sum (Left Margin Length)` |
| `margin_length_right` | Margin Length (right) | 2 | The total length of right valley bottom margins | `Sum (Right Margin Length)` |
| `proportion_sediment_source` | Proportion of Margin that is a Sediment Source | 2 | The proportion of total margin length that has potential to supply sediment to the stream | `Sum (Length of Margins with Sediment Source) / Sum (Total Margin Length)` |
| `proportion_wood_source` | Proportion of Margin that is a Wood Source | 2 | The proportion of total margin length that has potential to supply wood to the stream | `Sum (Length of Margins with Wood Source) / Sum (Total Margin Length)` |
  </TabItem>
</Tabs>
...
<ToolsWrapper
    ...
    cards={[
        ...
        description: "Geomorphic Mapping and Taxonomy of Fluvial Landforms.",
        logoUrl: "/images/icons/reading.png",
