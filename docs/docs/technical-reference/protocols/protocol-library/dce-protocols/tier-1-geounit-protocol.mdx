...
| `active_channel_area` | Area of Active Channel(s) within Valley Bottom of Each Sample Frame | 2 | Area of Active Channel within Valley Bottom of Each Sample Frame | `Sum (Active Channel Area)` |
