...
<ToolsWrapper
    ...
    cards={[
        ...
        description: "Syllabus on LTPBR USU Site.",
...
This course will be focused on how we quanatitative use mapping and analysis in QRiS to build off of:
  - Reading Riverscapes & Mapping the Valley Bottom ([Module 3C](https://lowtechpbr.restoration.usu.edu/workshops/2020/SGI/Modules/module3/))
  - Mapping and Estimating Structural Forcing ([Module 3D](https://lowtechpbr.restoration.usu.edu/workshops/2020/SGI/Modules/module3/#d-recognizing-structural-forcing-in-riverscapes))
  - Mapping Risk & Recovery Potential ([Module 4C](https://lowtechpbr.restoration.usu.edu/workshops/2020/SGI/Modules/module4/))
