...
![Getting Started](/images/getting-started/getting-started.excalidraw.svg)
...
To get started with a typical LTPBR workflow, check out [this tutorial](/tutorials/getting-started/tutorial_workflow).
