...
QRiS is compatible with QGIS versions 3.34.0 to 3.40.0, so be sure to install those versions from the ***Downloads List Page*** (see below). If a specific QGIS version is required for a particular QRiS release, this information will be provided in the [release notes](https://github.com/Riverscapes/QRiS/releases) or as a pop-up within the QGIS Plugin Manager.

<ToolsWrapper
    cardsize="lg"
    cards={[
        {
        title: "QRiS Downloads List Page",
        description: "List of all current and preivous QGIS releases.",
        logoUrl: "https://docs.riverscapes.net/img/tools/qgis-logo_anita02.png",
        toolUrl: "https://www.qgis.org/downloads-list/",
       },
    ]}
    />
<ToolsWrapper
