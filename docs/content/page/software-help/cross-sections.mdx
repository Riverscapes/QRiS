...
Cross sections can also be used to subdivide a polygon into segments as a way of generating a [sampling frame](/software-help/sampling-frames).
...
You can use the cross sections to segment a valley bottom polygon into a riverscapes [sampling frame](/software-help/sampling-frames). To do this, right click on the cross section in the project tree and select **Generate Sampling Frame**. This will open a window where you can specify the name and description of the sampling frame. You can also specify metadata key/value pairs for important information about the database. Click **OK** and the sampling frame will be created and displayed in the map view.
