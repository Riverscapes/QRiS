...
If you don't have it already, you will need QGIS to use QRiS. QGIS is a free and open source GIS software package. You can download it from the [QGIS website](https://qgis.org/en/site/forusers/download.html).
